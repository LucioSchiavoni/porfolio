...
<a href='https://www.linkedin.com/in/lucio-schiavoni-a67a82238/'>
  ...
  <div className='mt-20 h-screen  grid grid-cols-2 gap-4 shadow-xl mb-80  bordered-lg card' id='sobremi'>
      ...
      <div data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" className='text-2xl w-11/12 mt-20 ml-20 text-black' >
        <p className='mt-10' >Mi nombre es Lucio, tengo 24 años y curso mi ultimo año de Informatica en UTU Arias Balparda de la ciudad de Montevideo. Me especializo en la orientación de desarrollo de Software y desarrollador Fullstack, esto ultimo en una academia virtual llamada Coderhouse.</p>

<p className='mt-10' > Soy autodidacta y disfruto mucho creando proyectos cliente/servidor. También soy un apasionado de las finanzas, lo que me llevó a adentrarme en el mundo del blockchain y la web3, donde me gusta explorar y crear proyectos descentralizados.
</p>
...
<div id='habilidades' >
   ...
   
  {
    icons.map((icons) => {
      ...
      <div key={icons.id} className='flex card w-11/12 bg-white  hover:scale-125 shadow-xl border-transparent  bordered-lg center-items justify-center text-2xl border transition hover:delay-150 duration-300 ease-in-out p-4 text-black gap-3' > 
...
<div className='form-control   mt-5 mb-4' >
  <h2 className=' grid grid-cols-2 mb-2 font-bold text-2xl font-mono text-[#153153]'> Contacta conmigo </h2> 
  <p className='mb-5 grid grid-cols-2 mb-2 text-small font-mono text-[#153153]'> Enviame un email </p> 
